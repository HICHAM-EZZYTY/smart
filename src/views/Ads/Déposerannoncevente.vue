...
//       Travaux,
    ...
    methods: {
		...
		next:function(){
            ...
            else if ( this.$store.state.count>=this.pagesCount){
                this.$store.state.count=this.pagesCount
            ...
            // console.log("hada counter fi store",this.$store.state.count)
            // this.$store.commit('increment');
            ...
            // console.log("Incr Of next",this.Incr)
            // console.log("pwidth Of next",this.Pwidth[this.Incr])
		...
		previous:function(){
            ...
            // console.log("Incr Of Previous",this.Incr)
            // console.log("pwidth Of Previous",this.Pwidth[this.Incr-1])
