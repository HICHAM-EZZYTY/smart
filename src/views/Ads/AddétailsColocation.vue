  ...
  <div class="adddetails">
    ...
    <div class="layoutbody ml-4 mt-8 grid lg:gap-28 lg:grid-cols-10">
      <div class="lg:col-span-2">
        ...
        <!-- <div class=" mr-4 ml-4 mt-3 flex lg:mr-0" >
          <p>Tags :</p>
      ...
      <div class="lg:col-span-8 lg:mt-4 lg:ml-8">
        ...
        <Aproximite v-if="indexoftabs == 1" :obj="testingObj" :IsLocation="false" class="mt-4" />
