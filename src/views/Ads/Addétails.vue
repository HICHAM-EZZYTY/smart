  ...
  <div class="adddetails">
          ...
          <div
            style="
              background-image: url('assets/Addétails/Pic7.jpg'),
                linear-gradient(rgba(33, 49, 66, 0.8), rgba(33, 49, 66, 0.6));
        ...
        >
          ...
          <div class="mapbanner">
            <div class="containerbtn flex">
              <div class="explorerbtn">Explorer quartier</div>
    ...
    <div class="layoutbody ml-4 mt-8 grid lg:gap-28 lg:grid-cols-10">
      <div class="lg:col-span-2">
        ...
        <div v-if="testingObj.isViager && DisableFor(['colocation', 'location'], testingObj.annonceType)" class="pricepartion mr-4 ml-4 mt-3 flex lg:mr-0">
          <p>Rente :</p>
          <h1 :style="(AllowFor(['vente', 'neuf'], testingObj.annonceType))?{} :{color:'#94A6B5'}" >344,000 € /mois</h1>
        </div>
         <div class="pricepartion mr-4 ml-4 mt-3 flex lg:mr-0" v-if="DisableFor(['neuf','vente'], testingObj.annonceType)">
          <p>Caution :</p>
          <h1 
          :style="(AllowFor(['colocation', 'location'], testingObj.annonceType))?{}: {color:'#94A6B5'}"
          >39,000 €</h1>
        </div>
        ...
        <div class="pricepartion mr-4 ml-4 mt-3 flex lg:mr-0" v-if="DisableFor(['location','neuf'], testingObj.annonceType)">
          <p>Taxe fonciére :</p>
          <h1 style="color: #94a6b5">120,000 €</h1>
        </div>

        <div class="pricepartion mr-4 ml-4 mt-3 flex lg:mr-0" v-if="DisableFor(['location','neuf'], testingObj.annonceType)">
          <p>Taxe d'habitation :</p>
          <h1 style="color: #94a6b5">39,000 €</h1>
        </div>
       
        <div class="pricepartion mr-4 ml-4 mt-3 flex lg:mr-0" v-if="DisableFor(['neuf','colocation','vente'], testingObj.annonceType)">
          <p>Disponibilité :</p>
          <h1 style="color: #94a6b5">39,000 €</h1>
        </div>
        <div class="pricepartion mr-4 ml-4 mt-3 flex lg:mr-0" >
        ...
        <div class="badgeairbnb" 
              v-if="
              AllowFor(AMI, testingObj.bienType) && 
              DisableFor(['location','colocation','neuf'], testingObj.annonceType) 
              "
              >
        ...
        <button class="btnbdg">Calculer le revenu</button>
      </div>
      <div class="lg:col-span-8 lg:mt-4 lg:ml-8">
        ...
        <div class="tabs-wrapper">
          <div class="tabs">
            ...
            <p 
              @click="activeLink($event);indexoftabs = 1;" 
              >
              À proximité
            </p>
             <p 
              v-if="AllowFor(['neuf'], testingObj.annonceType)"
              >
              Prix et plan
            </p>
            <p
              @click="
                ...
                indexoftabs = 2;
              "
              v-if="AllowFor(AMI, testingObj.bienType) && DisableFor(['colocation'], testingObj.annonceType)"
            >
              Historique des prix
            </p>
            <p
            ...
            <p
              ...
              v-if="DisableFor(['colocation','location'], testingObj.annonceType)"
            >
        ...
        <Aproximite v-if="indexoftabs == 1" :obj="testingObj" :isAllowedForPCBP="AllowFor(PCBP, testingObj.bienType)" class="mt-4" />
...
export default {
  ...
  data() {
    return {
        ...
        LFT:["FondsCommerce","Terrain", "LocalCommmercial"],
  ...
  methods: {
   ...
   created:function(){
      //  this.testmethod();
      // console.log(this.AllowFor(this.LCHP, this.testingObj.bienType));
    }
};
</script>
