...
//       Travaux,
    ...
    methods: {
		...
		next:function(){
			...
			if(this.$store.state.countColocation<1 ){
                this.$store.state.countColocation=1
                this.Incr=1
            }
            else if ( this.$store.state.countColocation>=this.pagesCount){
                this.$store.state.countColocation=this.pagesCount
                this.Incr=this.pagesCount
            }
			else
            this.$store.commit('incrementColocation');
		...
		previous:function(){
            ...
            else if (this.$store.state.countColocation>1){
                    this.Incr=this.Incr-1
                    this.$store.commit('decrementColocation');
                }
          ...
          mounted(){
            this.Incr=this.$store.state.countColocation
