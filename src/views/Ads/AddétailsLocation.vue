<template>
  <div class="adddetails">
    ...
    <div class="popupshare flex justify-end mr-6">
        ...
        <Aproximite v-if="indexoftabs == 1" :obj="testingObj" :IsLocation="true" class="mt-4" />
