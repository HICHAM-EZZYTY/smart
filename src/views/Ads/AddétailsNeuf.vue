    ...
    <div class="headerlayout ml-4 grid gap-1 lg:grid-cols-9">
      <div class="lg:col-span-2">
        ...
        <div class="picbox flex mb-2">
          ...
          <div
            style="
            background-image: url('assets/Addétails/Pic7.jpg'); background-color: rgba(33, 49, 66, 0.6); background-blend-mode: multiply;
            "
            class="picsofad h-48 ml-2 sm:h-64"
          >
            <p>+13</p>
      ...
      <div class="lg:col-span-8 lg:mt-4 lg:ml-8">
        ...
        <div class="tabs-wrapper">
          <div class="tabs">
            ...
            <p 
              @click="activeLink($event);indexoftabs = 6;" 
              >
              À proximité
            </p>
             <p 
              
              @click="activeLink($event);indexoftabs = 10;" 
              >
        ...
        <Aproximite v-if="indexoftabs == 6" :obj="testingObj" :IsLocation="false" class="mt-4" />
        ...
        <Plan  v-if="indexoftabs == 10" class="mt-4"/>
