...
<div class="wrapper">
            ...
            <div class="closeicon relative ">
        <img class="w-4" src="../assets/Pics/closeicon.svg" alt="icon de fermeture">
        </div>


    <div class="forgetpassword  relative w-5/6 m-auto m-0 mt-4 h-screen sm:w-9/12 md:w-8/12 lg:w-6/12 xl:w-5/12">

        <div class="sketchmailing  relative m-auto m-0 mb-24">
        <!-- <img class="w-full absolute sktechmailingpic" src="../assets/Pics/chekmail.svg" alt="icon de vérification d'émail"> -->

        <svg  class="w-full absolute sktechmailingpic" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                ...
                <polygon fill="#2C8EEA" points="80.162,59.326 80.162,45.717 75.939,45.717 75.939,59.33 80.162,59.33 "/>
                <polygon fill="none" points="75.939,59.33 80.162,59.33 80.162,59.326 80.162,45.717 75.939,45.717 "/>
                <g>
                    <polygon fill="#2C8EEA" points="75.939,59.33 80.162,59.33 80.162,59.326 80.162,45.717 75.939,45.717 	"/>
                    <path fill="#2C8EEA" d="M89.982,34.364c-1.094-1.085-2.597-1.759-4.25-1.759h-10.69h-0.001v-0.016h-0.018v-0.146
        ...
        <h2 class="w-full m-auto m-0 text-center">Félicitation</h2>
        <h4 class="w-full m-auto m-0 text-center ">Bienvenue parmis nous , votre compte est bien activer</h4>

        
        <button type="submit" class="btn-sbmt  m-auto m-0  block relative h-10 w-5/6 capitalize mt-4 mb-3">
                                Merci
        </button>

        
        <h6 class="">Retour à la page d'accueil</h6>
