<template>
     <div class="surveycontainer">
            ...
            <div v-if="this.$store.state.count==4" class="survey4"> 
                ...
                <Consomations class="" />
                <Annonceheading title="Emission de gaz à effet de serr" Numbers="17" class="mb-4 mt-4" />
                <Emissiongaz class="" />
                <Annonceheading title="Année de construction" Numbers="18" class="mb-4 mt-6" />
            ...
            <div v-if="this.$store.state.count==5" class="survey3">  
                ...
                <Typedemaison class="" />
                <Annonceheading title="Prix vente" Numbers="21" class="mb-4" />
