<template>
    ...
    <div class="Lespace block m-0 m-auto mb-8 w-4/5 md:w-3/4 lg:w-3/5">
    ...
    <div class="séjours grid grid-cols-1 gap-4 w-full md:w-4/5 mt-3  md:grid-cols-9">
        ...
        <div class="inpt1 relative w-2/5 md:w-4/5 md:col-span-3 lg:col-span-2">
            ...
            <input  v-model="indexofsej" v-on:keydown="nmbfsej()"  class="w-full" type="number" min="1" max="100"   oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
